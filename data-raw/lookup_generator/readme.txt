...
To update the ooi_science.rda file, you will need to first run the make_ooi_master.py file to generate the master file.
Next, run master_to_science.py to create the science file.
Finally, run csv_to_rda.R to save the file in a packageable format.
